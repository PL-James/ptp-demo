...
import { ActionRoles, Dynamic, ForAngularCommonModule, KeyValue, ModalComponent } from '@decaf-ts/for-angular';
import { IonButton } from '@ionic/angular/standalone';
import { TranslatePipe } from '@ngx-translate/core';
import { Diffs, ProductImage } from '@pharmaledgerassoc/ptp-toolkit/shared';
import { getExpiryDateDiffValue } from 'src/app/handlers/BatchHandler';
