...
import { Batch, LeafletType, Product } from '@pharmaledgerassoc/ptp-toolkit/shared';
...
export class AppSelectFieldComponent extends CrudFieldComponent implements AfterViewInit {
  ...
  override async ngAfterViewInit(): Promise<void> {
    ...
    if (this.name === 'batchNumber') {
      ...
      if ((this.value as string)?.length) {
        ...
        //   value: this.value,
        // });
        const timerSubscription = timer(200).subscribe(() => {
